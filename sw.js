...
const C = "cwallet-nf-9";
const ASSETS = ["./","./index.html","./manifest.webmanifest","./icon-180.png","./icon-192.png","./icon-512.png","./assets/hero-orbit.webp","./assets/insight-orbit.webp","./assets/cora-empty.webp"];
